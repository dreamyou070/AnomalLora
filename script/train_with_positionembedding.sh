...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${obj_name}/up_2_position_embedder_pooling_up_2" \
 ...
 --num_repeat 1 --anomal_only_on_object \
 --unet_inchannels 4 --min_timestep 0 \
 --max_timestep 1000 --total_normal_thred 1 \
 --latent_res 64 --d_dim 320 --use_pe_pooling --position_embedding_layer 'up_blocks_3_attentions_2_transformer_blocks_0_attn2'