...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_config \
 ...
 --log_with wandb \
 --output_dir "../../result/${obj_name}/up_2_not_anomal_hole_act_deact_do_down_dim_mahal_loss_map_loss_with_focal_loss_unet_position_embedding" \
 --pretrained_model_name_or_path ../../../pretrained_stable_diffusion/stable-diffusion-v1-5/v1-5-pruned.safetensors \
 --data_path '../../../MyData/anomaly_detection/MVTec3D-AD' --beta_scale_factor 0.8 \
 --use_position_embedder --position_embedding_layer 'unet' --d_dim 320 --latent_res 64 --position_embedding_layer 'unet' \
