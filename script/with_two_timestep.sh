...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 --main_process_port $port_number ../with_two_timestep.py \
 --log_with wandb --wandb_api_key 3a3bc2f629692fa154b9274a5bbe5881d47245dc \
 --output_dir "../../result/${obj_name}/with_two_timestep" \
 ...
 --background_with_normal --start_epoch 0 --num_repeat 1 --anomal_only_on_object --unet_inchannels 4 --max_train_epochs 1 \
