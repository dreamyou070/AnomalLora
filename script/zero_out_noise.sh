...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${obj_name}/3_caption_bagel_64_up_zero_out_pseudo_anomal_with_init_noise" \
 ...
 --background_with_normal --truncating --pseudo_anomal_with_init_noise