...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/1_3_train_anomalous_detector_not_small_anomal_use_anormal_attention_mask" \
 ...
 --do_anomal_hole --use_anormal_attention_mask