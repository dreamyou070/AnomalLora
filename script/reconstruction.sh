...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/caption_good_res_64_general_anomal_source_partial_anomal_attnloss_1_anomal_th_max_anomal_sample_normal_loss_down_dim_160/models" \
