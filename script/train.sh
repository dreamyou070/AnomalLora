...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/20_3_do_anomal_sample_do_attn_loss_do_dist_loss_do_map_loss" \
 ...
 --do_anomal_sample \
 --do_attn_loss --attn_loss_weight 1.0 --do_cls_train --normal_weight 1.0 --do_dist_loss \
 --do_map_loss

 # --do_normal_sample --do_dist_loss
 #
