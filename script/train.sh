...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/20_5_do_normal_sample_attn_loss" \
 ...
 --do_normal_sample --do_attn_loss --attn_loss_weight 1.0 --do_cls_train --normal_weight 1.0
