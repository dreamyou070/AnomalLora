...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/20_6_only_anomal_hole_normal_weight_0" \
 ...
 --do_attn_loss --attn_loss_weight 1.0 --do_cls_train --normal_weight 0.0 --trg_layer_list "['up_blocks_3_attentions_2_transformer_blocks_0_attn2']" \
