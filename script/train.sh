...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/23_1_4_do_holed_sample_do_normal_sample_do_attn_loss_forth_attn_gen_code" \
 ...
 --do_holed_sample --do_normal_sample \
 --do_attn_loss --attn_loss_weight 1.0 --do_cls_train --normal_weight 1.0 --attention_loss_check_forth