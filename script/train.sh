...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/12_up_2_anomal_pe_down_new_mahal" \
 --train_unet --train_text_encoder --start_epoch 3 --max_train_epochs 30 \
 --pretrained_model_name_or_path ../../../pretrained_stable_diffusion/stable-diffusion-v1-5/v1-5-pruned.safetensors \
 --network_weights "../../result/${bench_mark}/${obj_name}/12_up_2_anomal_pe_down_new_mahal/models/epoch-000003.safetensors" \
