...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/10_up_2_anomal_pe_down_down_mahal_task_loss_only_local_self_attn" \
 ...
 --do_map_loss --do_local_self_attn --window_size 8 --only_local_self_attn