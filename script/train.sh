...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${bench_mark}/${obj_name}/23_4_2_do_holed_sample_do_normal_sample_do_attn_loss_do_dist_loss_do_map_loss_second_attn_gen_code" \
