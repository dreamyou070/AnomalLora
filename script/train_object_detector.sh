...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 --main_process_port $port_number ../train_object_detector.py --log_with wandb \
 --output_dir "../../result/${bench_mark}/${obj_name}/object_detector" \
 ...
 --do_dist_loss --dist_loss_weight 1.0 --use_position_embedder --position_embedding_layer "none" \
 ...
 --do_anomal_hole --use_small_anomal