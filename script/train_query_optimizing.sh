...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 --main_process_port $port_number ../train_query_optimizing.py \
 --log_with wandb --wandb_api_key 3a3bc2f629692fa154b9274a5bbe5881d47245dc \
 --output_dir "../../result/${obj_name}/train_query_optimizing" \
 --network_weights "../../result/${obj_name}/3_caption_bagel_1_without_taskloss_dist_loss_background_with_normal_more_anomal_srcs_anomal_detail/models/epoch-000001.safetensors" \
 ...
 --marginal_attn_loss --marginal_dist_loss --background_with_normal --truncating