...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/up_2_basic_pe_beta_scale_0.8_rand_aug_data/models" \
 --data_path "../../../MyData/anomaly_detection/MVTec3D-AD/${obj_name}/test" \
 --obj_name "${obj_name}" --network_dim 128 --network_alpha 4 --unet_inchannels 4 --prompt "${caption}" --latent_res 64 \
