...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/up_2_position_embedder_pooling_down_0/models" \
 ...
 --d_dim 320 --use_pe_pooling --position_embedding_layer "down_blocks_0_attentions_0_transformer_blocks_0_attn1"