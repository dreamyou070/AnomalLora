...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/up_2_position_embedder_up_2_new_code_concat/models" \
 ...
 --do_concat --d_dim 320 --use_position_embedder --position_embedding_layer "up_blocks_3_attentions_2_transformer_blocks_0_attn2"