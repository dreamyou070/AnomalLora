...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/up_2_position_embedder_down_0_self_small_anomal_data/models" \
 ...
 --d_dim 320 --use_position_embedder --position_embedding_layer 'down_blocks_0_attentions_1_transformer_blocks_0_attn1'