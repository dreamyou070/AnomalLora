...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/up_2_basic_pe_beta_scale_0.8_add_query/models" \
 ...
 --do_add_query --add_query_layer_list "['down_blocks_0_attentions_0_transformer_blocks_0_attn1']"