...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config \
 ...
 --output_dir "../../result/${obj_name}/1_caption_bagel_1_not_concern_background_without_taskloss_more_anomal_srcs" \
 ...
 --num_epochs 300 --start_epoch 0 --num_repeat 1 --anomal_only_on_object --unet_inchannels 4