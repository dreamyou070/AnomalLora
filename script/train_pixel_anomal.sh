...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config \
 ...
 --output_dir "../../result/${obj_name}/caption_bagel_pixel_anomal_up_attn_loss_0.008_new_code_repeat_1" \
 ...
 --do_attn_loss --attn_loss_weight 0.008 --do_cls_train --normal_weight 1 \
 --num_epochs 100 --start_epoch 0 --num_repeat 1