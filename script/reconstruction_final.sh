...
accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 ...
 --network_folder "../../result/${obj_name}/4_caption_bagel_1_not_concern_background_without_taskloss_more_anomal_srcs_srcs_anomal_detail_normal_dist_loss_squere/models" \
