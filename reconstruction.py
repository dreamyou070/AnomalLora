    ...
    for model in models:
        ...
        for thred in args.threds :
            ...
            for anomal_folder in anomal_folders:
                ...
                object_mask_folder = os.path.join(anomal_folder_dir, 'back_rm_object_mask')

                rgb_imgs = os.listdir(rgb_folder)

                for rgb_img in rgb_imgs:

                    object_mask_dir = os.path.join(object_mask_folder, rgb_img)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_object_mask", action='store_true')
    # step 8. test
    import ast
    def arg_as_list(arg):
