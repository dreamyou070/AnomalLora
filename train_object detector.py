    ...
    for epoch in range(args.start_epoch, args.max_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            for trg_layer in args.trg_layer_list:
                ...
                normal_cls_score, normal_trigger_score = cls_score * object_position, trigger_score * object_position
                ...
                attn_loss += args.normal_weight * (normal_trigger_loss.mean() + normal_cls_loss.mean())

            # [5] backprop
            if args.do_dist_loss:
                normal_dist_max, normal_dist_loss, mu, cov = gen_mahal_loss(args, None, normal_feat_list, mu, cov)
